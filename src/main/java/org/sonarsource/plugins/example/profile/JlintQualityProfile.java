 ...
 */
package org.sonarsource.plugins.example.profile;
 ...
 */
public final class JlintQualityProfile implements BuiltInQualityProfilesDefinition {

  @Override
  public void define(Context context) {
    NewBuiltInQualityProfile profile = context.createBuiltInQualityProfile("FooLint Rules", Java.KEY);
