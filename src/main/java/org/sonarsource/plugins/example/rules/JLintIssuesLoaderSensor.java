 ...
 */
public class JLintIssuesLoaderSensor implements Sensor {

    private static final Logger LOGGER = Loggers.get(JLintIssuesLoaderSensor.class);
     ...
     */
    public JLintIssuesLoaderSensor(final Configuration config, final FileSystem fileSystem) {
...
//        }
    ...
    public String toString() {
        return "JLintIssuesLoaderSensor";
    }
