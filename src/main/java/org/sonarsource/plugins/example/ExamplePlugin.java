...
import org.sonarsource.plugins.example.profile.JlintQualityProfile;
import org.sonarsource.plugins.example.rules.CreateIssuesOnJavaFilesSensor;
import org.sonarsource.plugins.example.rules.JLintIssuesLoaderSensor;
...
public class ExamplePlugin implements Plugin {
    ...
    public void define(Context context) {
        ...
        context.addExtension(JlintQualityProfile.class);
//        context.addExtension(FooLanguageProperties.getProperties());
        ...
        context.addExtensions(FooLintRulesDefinition.class, JLintIssuesLoaderSensor.class);
